const NewArrival = () => {
  return (
    <div className="">
      ...
      <div className="grid md:grid-cols-2 gap-[30px] md:px-0 px-14">
        <div className="relative">
          <div className="bg-black text-white md:w-full w-[300px]  p-14">
            <img src="/images/PlayStation-5.svg" alt="" className="" />
            <div className=" absolute bottom-28  w-[250px] space-y-2">
        ...
        <div className="">
          ...
          <div className="bg-black text-white   relative">
            <img
              ...
              alt=""
              className="md:ml-72  pt-10"
            />
            <div className=" absolute top-52 space-y-2  left-8 md:w-[570px] w-[100px] h-[284px]">
          ...
          <div className="md:flex flex-row justify-between mt-4 gap-5  relative ">
            {/* speakers card */}
            <div className="w-[350px] h-[284px]  bg-[#1F1F1F] text-white">
              ...
              />
              <div className="absolute md:bottom-6 left-8">
            ...
            {/* Perfume card */}
            <div className="bg-[#2C2C2C] text-white w-[350px] h-[284px] md:my-0 mt-4  relative">
              <img
